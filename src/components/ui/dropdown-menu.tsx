...
// ✅ Common green hover/focus style (reusable)
const greenHover =
  "hover:bg-[#119D82] hover:text-white focus:bg-[#119D82] focus:text-white data-[state=open]:bg-[#119D82] data-[state=open]:text-white";
